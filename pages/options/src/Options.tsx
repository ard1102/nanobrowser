...
import { FiSettings, FiCpu, FiShield, FiTrendingUp, FiHelpCircle, FiSend } from 'react-icons/fi';
...
type TabTypes = 'general' | 'models' | 'firewall' | 'analytics' | 'telegram' | 'help';
...
const TABS: { id: TabTypes; icon: React.ComponentType<{ className?: string }>; label: string }[] = [
  ...
  { id: 'telegram', icon: FiSend, label: 'Telegram' },
...
const Options = () => {
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      ...
      case 'telegram':
        return <TelegramSettings isDarkMode={isDarkMode} />;
      default:
        return null;
    }
  };
